...
var statements = {
	...
	tdefVersion: require('./statements/tdefVersion'),
	duVersion: require('./statements/duVersion'),
	integer: require('./statements/integer'),
	latest: require('./statements/latest'),
	release: require('./statements/release')
};
